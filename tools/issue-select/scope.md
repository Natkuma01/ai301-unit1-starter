...
- Link: https://github.com/codepath/pathreview-ai301-fa26-s1
...
I have intermediate coding experience, mostly with Python and JavaScript.
I have worked on full-stack projects with React and Django. I am comfortable
with APIs, databases, Git, and basic cloud tools.

I want to learn how to contribute to open-source projects and find my way
around a larger codebase. I also want to use AI tools well in a real
development workflow. A focused Python or JavaScript issue would let me
use what I already know while learning how to test a change and prepare
a clear pull request.
